...
Title.TextColor3 = Color3.new(0, 0, 0.498039)
...
ChatTroll.TextColor3 = Color3.new(0, 0, 0.498039)
...
StatChanger.TextColor3 = Color3.new(0, 0, 0.498039)
...
Chatlvl100.TextColor3 = Color3.new(0, 0, 0.498039)
...
Title_2.TextColor3 = Color3.new(0, 0, 0.498039)
...
chatcolor.TextColor3 = Color3.new(0, 0, 0.498039)
...
Red.Position = UDim2.new(0.249388367, 0, 0.157556295, 0)
...
chatprefix.TextColor3 = Color3.new(0, 0, 0.498039)
...
prefix.PlaceholderColor3 = Color3.new(0, 0, 0.498039)
prefix.PlaceholderText = "Make a fake player prefix ([player]:). Leave blank for no prefix"
prefix.Text = ""
prefix.TextColor3 = Color3.new(0, 0, 0.498039)
...
autodetectplayers.TextColor3 = Color3.new(0, 0, 0.498039)
...
message.Text = ""
message.TextColor3 = Color3.new(0, 0, 0.498039)
...
hide.Text = "Hide UI"
hide.TextColor3 = Color3.new(0, 0, 0.498039)
...
postmessage.TextColor3 = Color3.new(0, 0, 0.498039)
...
PP.PlaceholderColor3 = Color3.new(0, 0, 0.498039)
PP.PlaceholderText = "PP"
PP.Text = ""
PP.TextColor3 = Color3.new(0, 0, 0.498039)
PP.TextScaled = true
PP.TextSize = 14
PP.TextWrapped = true
...
Accuracy.PlaceholderColor3 = Color3.new(0, 0, 0.498039)
Accuracy.PlaceholderText = "Accuracy"
Accuracy.Text = ""
Accuracy.TextColor3 = Color3.new(0, 0, 0.498039)
...
Power.PlaceholderColor3 = Color3.new(0, 0, 0.498039)
Power.PlaceholderText = "Power"
Power.Text = ""
Power.TextColor3 = Color3.new(0, 0, 0.498039)
...
CritChance.PlaceholderColor3 = Color3.new(0, 0, 0.498039)
CritChance.PlaceholderText = "Critical Hit Chance"
CritChance.Text = ""
CritChance.TextColor3 = Color3.new(0, 0, 0.498039)
...
MoveName.PlaceholderColor3 = Color3.new(0, 0, 0.498039)
MoveName.PlaceholderText = "Put Move Name Here"
MoveName.Text = ""
MoveName.TextColor3 = Color3.new(0, 0, 0.498039)
...
PokemonName.PlaceholderColor3 = Color3.new(0, 0, 0.498039)
PokemonName.PlaceholderText = "Put Pokemon Name Here"
PokemonName.Text = ""
PokemonName.TextColor3 = Color3.new(0, 0, 0.498039)
...
Atk.PlaceholderColor3 = Color3.new(0, 0, 0.498039)
Atk.PlaceholderText = "Attack"
Atk.Text = ""
Atk.TextColor3 = Color3.new(0, 0, 0.498039)
Atk.TextScaled = true
Atk.TextSize = 14
...
Def.PlaceholderColor3 = Color3.new(0, 0, 0.498039)
Def.PlaceholderText = "Defense"
Def.Text = ""
Def.TextColor3 = Color3.new(0, 0, 0.498039)
Def.TextScaled = true
Def.TextSize = 14
...
HP.PlaceholderColor3 = Color3.new(0, 0, 0.498039)
HP.PlaceholderText = "HP"
HP.Text = ""
HP.TextColor3 = Color3.new(0, 0, 0.498039)
HP.TextScaled = true
HP.TextSize = 14
HP.TextWrapped = true
...
Speed.PlaceholderColor3 = Color3.new(0, 0, 0.498039)
Speed.PlaceholderText = "Speed"
Speed.Text = ""
Speed.TextColor3 = Color3.new(0, 0, 0.498039)
...
SpA.PlaceholderColor3 = Color3.new(0, 0, 0.498039)
SpA.PlaceholderText = "Special Attack"
SpA.Text = ""
SpA.TextColor3 = Color3.new(0, 0, 0.498039)
SpA.TextScaled = true
SpA.TextSize = 14
...
SpD.PlaceholderColor3 = Color3.new(0, 0, 0.498039)
SpD.PlaceholderText = "Special Defense"
SpD.Text = ""
SpD.TextColor3 = Color3.new(0, 0, 0.498039)
SpD.TextScaled = true
SpD.TextSize = 14
...
ChangeMove.TextColor3 = Color3.new(0, 0, 0.498039)
...
ChangePokemon.TextColor3 = Color3.new(0, 0, 0.498039)
...
function SCRIPT_GJRJ73_FAKESCRIPT() -- PokemonHaxlol.LocalScript 
	...
	MainFrame.Chatlvl100.MouseButton1Click:connect(function()
	game.ReplicatedStorage.REvents.Internal.wouoz:FireServer("Attention: "..game.Players.LocalPlayer.Name.." is here and is granting you access to hax your pokemon. To do so you say '!lvl hack [pokemon name]' WITHOUT brackets or quotes in chat. (For all pokemon, do !lvl hack all)\nOnce you do that, kill another pokemon and let the magic begin.\nALSO: This cannot be undone + This supports shortened names ('pikachu' can be written as 'pika').", Color3.new(0,0.5,0.5))
	...
	game.ReplicatedStorage.REvents.Internal.fiaj:InvokeServer(pokemon, 1000000000)
	end
	end
	end
